...
def cd_to_datetime(calendar_date):
    ...
    :return: A naive `datetime` corresponding to the
    given calendar date and time.
    """
...
def datetime_to_str(dt):
    ...
    date, hour, and minute values. Additionally, this function provides
    the date in the usual ISO 8601 YYYY-MM-DD format to avoid ambiguities with
